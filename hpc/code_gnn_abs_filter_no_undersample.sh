...
singularity exec --nv main.sif python code_gnn/main.py --model flow_gnn --dataset MSR --feat "_ABS_DATAFLOW_datatypeonly_filtertoabs" \
    --clean --batch_size 16 --max_epochs 250 --weight_decay=1e-2 \
