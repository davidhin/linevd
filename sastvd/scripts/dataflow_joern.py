...
if __name__ == "__main__":
    ...
    parser.add_argument('--sample', action='store_true', help='Extract from only a sample')
    ...
    filepaths = df["id"].apply(
        lambda _id: list(filter(Path.exists,(svd.processed_dir() / f"bigvul/{d}/{_id}.c" for d in ("before", "after"))))
        )
