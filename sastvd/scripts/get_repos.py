...
def print_commit_ids_df():
    ...
    all_df = pd.read_csv("storage/external/MSR_data_cleaned.csv").rename(
...
def correct_repo_name(cid):
    bigmap = {
        "http://git.infradead.org/users/dwmw2/openconnect.git": "git://git.infradead.org/users/dwmw2/openconnect.git",
        "http://git.infradead.org/users/steved/libtirpc.git": "git://git.infradead.org/users/dwmw2/openconnect.git",
        "http://git.linux-nfs.org/steved/libtirpc.git": "git://git.linux-nfs.org/projects/steved/libtirpc.git",
        "http://git.savannah.nongnu.org/cgit/exosip.git": "https://git.savannah.gnu.org/git/exosip.git",
        "http://git.wpitchoune.net/gitweb/psensor.git": "https://gitlab.com/jeanfi/psensor.git",
        "https://git.savannah.gnu.org/cgit/quagga.git": "https://github.com/Quagga/quagga",
        "https://git.savannah.gnu.org/gitweb/quagga.git": "https://github.com/Quagga/quagga",
        "https://git.enlightenment.org/apps/terminology.git": "http://git.enlightenment.org/enlightenment/terminology.git",
        "https://git.enlightenment.org/core/enlightenment.git": "http://git.enlightenment.org/enlightenment/enlightenment.git",
        "https://git.enlightenment.org/legacy/imlib2.git": "http://git.enlightenment.org/old/legacy-imlib2.git",
        "https://git.exim.org/exim.git": "git://git.exim.org/exim.git",
        "https://git.gnupg.org/cgi-bin/gitweb.cgi/gnupg.git": "git://git.gnupg.org/gnupg.git",
        "https://git.gnupg.org/cgi-bin/gitweb.cgi/gpgme.git": "git://git.gnupg.org/gpgme.git",
        "https://git.gnupg.org/cgi-bin/gitweb.cgi/libgcrypt.git": "git://git.gnupg.org/libgcrypt.git",
        "https://git.gnupg.org/cgi-bin/gitweb.cgi/libksba.git": "git://git.gnupg.org/libksba.git",
        "https://git.hylafax.org/HylaFAX.git": "https://github.com/ifax/HylaFAX.git",
        "https://git.lxde.org/gitweb/lxde/lxterminal.git": "https://github.com/lxde/lxterminal.git",
        "https://git.lxde.org/gitweb/lxde/menu-cache.git": "https://github.com/lxde/menu-cache.git",
        "https://git.lxde.org/gitweb/lxde/pcmanfm.git": "https://github.com/lxde/pcmanfm.git",
        "https://github.com/php/php-src.git.git": "https://github.com/php/php-src.git",
        "https://github.com/php/php-src": "https://github.com/php/php-src.git",
        "https://git.php.net/php-src.git": "https://github.com/php/php-src.git",
        "https://git.postgresql.org/gitweb/postgresql.git": "https://github.com/postgres/postgres",
        "https://git.qemu.org/qemu.git": "https://git.qemu.org/git/qemu.git",
        "https://git.qemu.org/gitweb.cgi/qemu.git": "https://git.qemu.org/git/qemu.git",
        "https://github.com/tomhughes/libdwarf": "https://github.com/davea42/libdwarf-code",
        "https://git.shibboleth.net/view/cpp-opensaml.git": "https://git.shibboleth.net/git/cpp-opensaml.git",
        "https://git.shibboleth.net/view/cpp-sp.git": "https://git.shibboleth.net/git/cpp-sp.git",
        "https://git.shibboleth.net/view/cpp-xmltooling.git": "https://git.shibboleth.net/git/cpp-xmltooling.git",
        "https://git.openssl.org/gitweb/openssl.git": "git://git.openssl.org/openssl.git",
        "https://git.openssl.org/openssl.git": "git://git.openssl.org/openssl.git",
        # multiple occurrences of rsync
        "https://git.samba.org/rsync.git/rsync.git": "https://git.samba.org/rsync.git",
        "https://git.quassel-irc.org/quassel.git": "https://github.com/quassel/quassel",
        "https://htcondor-git.cs.wisc.edu/condor.git": "https://github.com/htcondor/htcondor",
        ...
        "https://gitlab.freedesktop.org/drm/drm-misc": "https://gitlab.freedesktop.org/drm/misc",
        ...
        "https://gitlab.freedesktop.org/harfbuzz": "https://github.com/freedesktop/harfbuzz",
        "https://gitlab.freedesktop.org/harfbuzz.old": "git://anongit.freedesktop.org/harfbuzz.old",
        ...
        "https://gitlab.freedesktop.org/polkit": "https://gitlab.freedesktop.org/polkit/polkit",
        "https://gitlab.freedesktop.org/systemd/systemd": "https://github.com/freedesktop/systemd",
        "https://gitlab.freedesktop.org/udisks": "https://github.com/storaged-project/udisks",
        "https://gitlab.freedesktop.org/virglrenderer": "https://gitlab.freedesktop.org/virgl/virglrenderer",
    }
    if cid in bigmap:
        cid = bigmap[cid]
    ...
    cid = cid.replace("cgit.kde.org", "github.com/KDE").replace(
        "gitlab.kde.org", "github.com/KDE"
    )
    # replace git.savannah.gnu.org/*/ with git.savannah.gnu.org/git
    cid = (
        cid.replace("git.savannah.gnu.org/cgit", "git.savannah.gnu.org/git")
...
def archive_one_commit(row):
    ...
    try:
        cmd_out = subprocess.check_output(
            cmd, stderr=subprocess.STDOUT, cwd=clean_repo, shell=True, encoding="utf-8"
        )
        if cmd_out:
            out += "\n" + prefix + cmd_out
        return out
        ...
        return (
            out + f"""{prefix}error running command "{cmd}": {traceback.format_exc()}"""
        )
...
def archive_commits():
    ...
    df["dst_repo"] = df.apply(
        lambda row: (
            archive / f"{row['clean_repo_name']}__{row['commit_id']}.tar"
        ).absolute(),
        axis=1,
    )
    ...
    df = df[
        df.apply(
            lambda row: not (
                base / "archive" / f"{row['clean_repo_name']}__{row['commit_id']}.tar"
            )
            .absolute()
            .exists(),
            axis=1,
    ...
    with (
        ...
        tqdm.tqdm(
            p.imap_unordered(archive_one_commit, df.to_dict("records")),
            desc=f"archive {len(df)} commits",
            total=len(df),
        ) as pbar,
    ):
        for outcome in pbar:
...
def extract_archived_commits(split_idx=-1, n_splits=1):
    tar_files = [
        Path(l.strip()) for l in open(archive / "index_fixed.txt").readlines() if l
    ]
    ...
    try:
        for cd in tqdm.tqdm(
            map(extract, to_extract), total=len(to_extract), desc="untarring files"
        ):
            pass
    except:
        raise
...
def parse_with_joern(
    job_array_id=-1, n_splits=1, repos_path="repos/checkout3", stuff_idx=3
):
    ...
    print("input exists", df)
    df["checkout_filepath_dst"] = df["checkout_filepath"].apply(
        lambda fp: fp + ".cpg.bin"
    )
    df = df[
        df["checkout_filepath_dst"].apply(lambda fp: not Path(fp + ".cpg.bin").exists())
    ]
    print("output does not exist", df)
    ...
    sess = svdjs.JoernSession(
        f"cpg{stuff_idx}_{job_array_id}", logfile=logfile, clean=True
    )
